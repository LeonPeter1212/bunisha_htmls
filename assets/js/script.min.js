...
!(function () {
	...
	function e(e, t, l, r, o) {
		...
		new google.maps.Marker({
			position: s,
			icon: o || "/assets/img/markar-icon.png",
		}).setMap(a);
	}
	$(".google-map").length &&
...
!(function (e) {
		...
		e("img.svg").each(function () {
			...
			e.get(
				...
				function (e) {
					...
					void 0 !== a && (l = l.attr("id", a)),
						void 0 !== s &&
							(l = l.attr("class", s + " replaced-svg")),
						(l = l.removeAttr("xmlns:a")),
						t.replaceWith(l);
				},
				"xml"
			);
		...
		e(window)
			.bind("resize", function () {
				...
				e(this).width() <= 767.98 &&
					...
					e(".search-form").appendTo(".mobile-search"),
		...
		null !== l &&
			document.body.addEventListener("click", function (e) {
				!e.target.closest(".ap-post-form") &&
					l.classList.contains("highlighted") &&
	...
	function y(e) {
		e.preventDefault(),
			"basic" == this.dataset.drawer
				? (h.classList.remove("account"),
				  h.classList.remove("profile"),
				  h.classList.add("basic"),
				  h.classList.add("show"),
				  v.classList.add("show"))
				: "area" == this.dataset.drawer
				? (w.classList.add("show"), b.classList.add("show"))
				: "account" == this.dataset.drawer
				? (h.classList.remove("basic"),
				  h.classList.remove("profile"),
				  h.classList.add("account"),
				  h.classList.add("show"),
				  v.classList.add("show"))
				: "profile" == this.dataset.drawer &&
				  (h.classList.remove("basic"),
				  h.classList.remove("account"),
				  h.classList.add("profile"),
				  h.classList.add("show"),
				  v.classList.add("show"));
	}
	function k() {
	...
	m && m.forEach((e) => e.addEventListener("click", y)),
		v && v.addEventListener("click", k),
		g && g.forEach((e) => e.addEventListener("click", k)),
	...
	function T() {
		"level-one" == this.dataset.drawer
			? (f.classList.add("level-one"),
			  f.classList.add("show"),
			  f.classList.remove("level-two"),
			  v.classList.add("show"))
			: "level-two" == this.dataset.drawer &&
			  (f.classList.add("level-two"),
	...
	x &&
		...
		L && L.forEach((e) => e.addEventListener("click", T)),
		e(".atbd-upload-avatar").on("click", function (t) {
			t.preventDefault(), D(), e(".upload-avatar-input").click();
		}),
		(_ = ".menu-collapsable .atbd-menu__link"),
		e(".menu-wrapper .menu-collapsable " + (F = ".atbd-submenu")).slideUp(),
		e(".menu-wrapper " + _).on("click", function (t) {
	...
	function B(t) {
		t.preventDefault(),
			"label" == this.dataset.trigger
				...
				: "compose" == this.dataset.trigger && M.classList.add("show"),
			e(t.target).hasClass("label-close") && R.classList.remove("show");
	}
	function P(e) {
		e.preventDefault(),
			"label" == this.dataset.trigger
	...
	null !== E &&
		null !== z &&
		(E.addEventListener("click", B), q.addEventListener("click", B)),
		null !== z &&
			null !== O &&
			(z.addEventListener("click", P), O.addEventListener("click", P));
	...
	$ &&
		($.forEach((e) => e.addEventListener("click", W)),
	...
	function G(t, a, s) {
		var l, i;
		try {
			(i = e.datepicker.parseDate(s, t)),
				e.datepicker.parseDate(s, a) < i && ((l = t), (t = a), (a = l));
		} catch (e) {}
	...
	H &&
		...
		j &&
			N &&
			(j.addEventListener("click", Y), N.addEventListener("click", Y)),
		...
		e(".sales-target__progress-bar").each(function () {
			...
			e({ p: 0 })
				...
				.delay(200),
				100 == s && l.delay(2600).animate({ top: "18px" }, 200),
		...
		(e.fn.dateRangePicker = function (t) {
			...
			function n(s, l) {
				...
				(s = s.split(t.rangeSeparator)).length > 0
					? ((i = e.datepicker.parseDate(l, s[0])),
					  s.length > 1 && (o = e.datepicker.parseDate(l, s[1])),
					  (a = { start: i, end: o }))
					: (a = null);
			}
			return (
